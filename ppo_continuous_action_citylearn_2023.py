...
# to do
# get cleanrl working with the citylearnenv
# smoke test
# make the reward match the competition reward
# figure out the single agent vs. multi agent
# wandb logging


'''
CityLearn related code
'''
class WrapperEnv:
    """
...
class CleanRLtoCityLearnWrapper():
    ...
    def __getattr__(self, attr):
        # get access to underlyuing env attribibute
